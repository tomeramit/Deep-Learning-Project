function [AccTotal, objective_score]=CompareAlgorithms(A,B,GT,gphs,KQ,K,AccTotal,irep, jvar)
...
[X,objective_score]=KerGM_Pathfollowing_RandFourierFeature(A,B,lambda,num,para);
acc = matchAsg(X, asgT);
